"""
MCP 客户端管理 负责连接各种工具服务"
提供全局单例的 MCP 客户端，避免重复初始化- 负责连接各种工具服务"
"""

import asyncio
from typing import Optional, Dict, Any, List
from langchain_mcp_adapters.client import MultiServerMCPClient
from langchain_mcp_adapters.interceptors import MCPToolCallRequest# 这个类很强大，它可以同时连接好几个不同的 MCP 服务（比如日志服务、监控服务）
...
#这是一个高级技巧。如果 AI 调用工具时网络卡了一下，这个拦截器会自动帮它再试 3 次，大大提高稳定性。
